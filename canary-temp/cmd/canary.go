...
import (
	...
	pb "github.com/unnamed/home-services/canary/api/v1/canary"
	"github.com/unnamed/home-services/canary/pkg/canary"
	"github.com/unnamed/home-services/canary/pkg/canary/endpoints"
	"github.com/unnamed/home-services/canary/pkg/canary/transport"
...
func main() {
	...
	}
	{
		...
		g.Add(func() error {
			...
			pb.RegisterCanaryServiceServer(baseServer, grpcServer)
